              ...
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    Showing <span className="font-bold">{(page - 1) * pageSize + 1}</span> to <span className="font-bold">{Math.min(page * pageSize, data.meta.total)}</span> of <span className="font-bold">{data.meta.total}</span> employees
                  </p>
                </div>
                <div>
